...
# A traves del calculo del VIF stepwise descartamos variables muy correlacionadas
# 5/7/18
# Basado en: https://www.r-bloggers.com/collinearity-and-stepwise-vif-selection/
