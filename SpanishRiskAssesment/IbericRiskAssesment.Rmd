...
```{r output.lines=20, fig.align='center'}
...
```{r fig.align='center'}
plot(marcoclim$BIO1~marcoclim$BIO12, pch=19, col="blue",alpha=0.1, xlab="Precipitación Anual (mm)", ylab="Temperatura anual media (ºC x10)",main="Temperatura y Precipitación en la Península Ibérica")  
...
plot(pcaclim, type = "l")
summary(pcaclim)
plot(pcaclim$x[,1],pcaclim$x[,2], col = "blue",alpha=0.1)
```
...
```{r fig.align='center'}
denmark <- getData('GADM', country='DEN', level=0)
