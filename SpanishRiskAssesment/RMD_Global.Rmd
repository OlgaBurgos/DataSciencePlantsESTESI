...
Para generar un gráfico de denidad:
```{r, fig.cap= "Grafico de denisdad de Temperatura y Precipitación en la Península Ibérica"}
str(marcoclim)
...
Al trabajar con 19 varaibles, algunas producto lineal de otras, estamos trabajando con información redundante. Podemos basarnos en el criterio VIF para descartar algunas y probar el modelo mas adelante con todas las variables y con solo las seleccionadas. 
