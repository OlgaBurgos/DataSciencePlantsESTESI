...
author: "Erola APELLIDO, Olga Burgos, Gianluca Arauz, Ramón APELLIDO"
date: "July 10, 2018"
output:
  html_document:
    toc: true
...
1. Obtención de datos de otros paises y proyección sobre el marco climático ibérico
...
Gian -> Creo que deberíamos escribir una un introducción corta (tipo  abstract) para situar un poco el tema del trabajo.

## 1.1 Preguntas
Si las invasiones son exitosas por en coincidencia del clima, ¿qué especies estaráan bien en la península ibérica y son por tanto potencialmente invasoras?
...
# GIAN -> Hago un drop de NANs. Creo que los NANs son los datos correspondientes al mar. Asítenemos un dataframe más ligero y bonito.
...
# 6. OBTENCI?N DE DATOS DE OTROS PAISES Y PROYECCI?N SOBRE EL MARCO CLIM?TICO IB?RICO
