...
list.of.packages <- c("DataExplorer", "raster", "dismo", "plotly", "fmsb", "factoextra", "MASS","hypervolume","alphahull", "dplyr")
...
Explicar brevemente pasos futuros (Erola lo hace el lunes)
